...
<header>    
  <img src="../img/Logo Grand FLV.png" id="LogoFLV" alt="Image Logo FLV">
</header>
...
<body>
  ...
  <div id="blogArticles">
    ...
    <div class="contenerArticle">
      ...
      <div>
        <h1 class="blogText">#FLVCHEZVOUS...</h1>
          <p class="blogPara"> 
            In this particular context, the Foundation is closed until further notice. We look forward to seeing you with the exhibition The Morozov Collection. Modern art icons. While waiting to welcome you again, find us on #FLVchezvous, social networks and the "Fondation Louis Vuitton" application! Rediscover the artists of the Foundation's Collection on our online Collection, especially those recently exhibited in the Crossing Views sequence of the Cindy Sherman exhibition at the Foundation.
    ...
    <div class="contenerArticle">
      <img class="blogImages" src="../img/Article1.jpeg">
      <div>
        <h1 class="blogText">#FILMED TOUR OF THE CHARLOTTE PERRIAND EXHIBITION</h1>
          <p class="blogPara"> 
    ...
    <div class="contenerArticle">
      <img class="blogImages" src="../img/Article2.jpeg">
      <div>
    ...
    <div class="contenerArticle">   
      <img class="blogImages" src="../img/Article3.jpeg">
      <div>
        <h1 class="blogText">#ALBERTO GIACOMETTI</h1>
          <p class="blogPara"> 
    ...
    <div class="contenerArticle">
      <img class="blogImages" src="../img/Article5.png">
      <div>
        <h1 class="blogText">#ALEXANDER ROMANOVSKY RECITAL</h1>
          <p class="blogPara"> 
    ...
    <?php
      ...
      require_once 'config.php'; // On inclut la connexion à la base de données
        ...
        if(isset($_GET["id_articles"])){
          $id = $_GET["id_articles"]; 
          $bdd->exec("DELETE FROM articles WHERE id_articles =" . $id . "");
        };    

        if (isset($_POST['titre'], $_POST['contenu']) && !empty($_POST['titre']) && !empty($_POST['contenu']) && $_FILES["image"]["error"] === 0) {
          ...
          $sql = "INSERT INTO articles (titre, image, contenu) VALUES ('$titre', '$img', '$contenu')";
          $bdd->exec($sql);
        }

      $r = $bdd->query('SELECT * FROM articles ORDER BY id_articles DESC');

      while ($article = $r->fetch(PDO::FETCH_ASSOC)) { ?>
        <div class="articles">
          <img class='blogImages' src='<?php echo $article['image']; ?>'>
          <h1 class="blogText"> <?php echo $article['titre']; ?> </h1>
          <p class="blogPara"> <?php echo $article['contenu']; ?> </p>
          <?php
          //  if ($_SESSION['role'] === 'ADMIN') {
            echo "<a class='delete' href='blog.php?id=" . $article['id_articles'] . "'> Delete </a>";  
            ?>
        </div>
        <?php } ?>
